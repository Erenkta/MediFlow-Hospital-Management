...
public class SpecialtyController {
    ...
    @GetMapping("/{code}")
    public ResponseEntity<SpecialtyResponseDto> getSpecialtyByCode(@PathVariable(name = "code") String code){
        return ResponseEntity.status(HttpStatus.FOUND).body(service.findSpecialtyByCode(code));
    }
    @PutMapping("/{code}")
    public ResponseEntity<SpecialtyResponseDto> updateSpecialty(@PathVariable(name = "code")  String code, @RequestBody SpecialtyRequestDto requestDto){
        return ResponseEntity.status(HttpStatus.OK).body(service.updateSpecialty(code,requestDto));
    }
    @DeleteMapping("/{code}")
    public ResponseEntity<Void> deleteSpecialty(@PathVariable(name = "code") String code){
