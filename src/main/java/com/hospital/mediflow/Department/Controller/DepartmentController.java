...
public class DepartmentController {
    ...
    public ResponseEntity<DepartmentResponseDto> addSpecialties(@PathVariable Long id,@RequestBody List<String> specialties){
        return ResponseEntity.status(HttpStatus.OK).body(service.addSpecialties(id,specialties));
    }
    @PatchMapping("/{id}/remove-specialties")
    public ResponseEntity<DepartmentResponseDto> removeSpecialties(@PathVariable Long id,@RequestBody List<String> specialties){
