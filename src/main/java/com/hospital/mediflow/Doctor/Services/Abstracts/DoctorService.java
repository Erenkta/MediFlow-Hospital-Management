...
public interface DoctorService {
    ...
    List<DoctorResponseDto> findDoctorsByDoctorCode(@Nullable String specialty, @Nullable TitleEnum title);
    Page<DoctorResponseDto> findDoctorsByDoctorCode(@Nullable Pageable pageable,@Nullable String specialty, @Nullable TitleEnum title);
