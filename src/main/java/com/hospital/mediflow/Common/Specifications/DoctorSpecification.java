...
public class DoctorSpecification extends BaseSpecification<Doctor> {
    ...
    public static Specification<Doctor>  hasSpecialty(SpecialtyEnum specialty){
        return (root,query,criteriaBuilder) ->
                specialty == null ? null :criteriaBuilder.equal(root.get("specialty"), specialty);
    }

    public static Specification<Doctor> hasDoctorCode(SpecialtyEnum specialty, TitleEnum title){
